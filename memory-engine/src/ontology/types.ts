...
export type MemoryKind =
  ...
  | "claim"      // factual assertions (projected to threadclaw-graph.db)
  | "decision"   // recorded choices (projected to threadclaw-graph.db)
  | "entity"     // named things (projected to threadclaw-graph.db)
  | "relation"   // entity-to-entity relationships (projected to threadclaw-graph.db)
  | "loop"       // open tasks/questions (projected to threadclaw-graph.db)
  | "attempt"    // tool execution records (projected to threadclaw-graph.db)
  | "procedure"  // runbooks + anti-runbooks merged (projected to threadclaw-graph.db)
  | "invariant"  // constraints/rules (projected to threadclaw-graph.db)
  | "delta"      // state changes (projected to threadclaw-graph.db)
